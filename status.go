...
func status(w http.ResponseWriter, r *http.Request) {
	...
	databaseVersion := databaseVersionQueryResult[0].(string)
	...
	databaseMaxConnections, err := strconv.Atoi(databaseMaxConnectionsQueryResult[0].(string))
	if err != nil {
		log.Println(err)
		w.WriteHeader(http.StatusInternalServerError)
		return
	...
	openConnections := databaseOpenConnections[0].(int64)
